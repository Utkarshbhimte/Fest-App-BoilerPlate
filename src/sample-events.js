export const allEvents= {
    ...
    '0206': {
        name: "Sketch & Paint",
        desc: "Solo event. Required materials should be brought by participants. S'heets shall be provided. On the spot topics. Duration is 90 min",
        location: ' Mech Block ',
        time: ' 10:00 ',
        contact: ' 8197334611 ',
        participants: ['']
    ...
    '0207': {
        name: "Beat The Heat",
        desc: "Solo event. 2 rounds. No instruments allowed. Time limit is 2 minutes. Qualified participants wi'll have beatbox sessions of 90 seconds each",
